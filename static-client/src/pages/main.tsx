            ...
            <Script
                ...
                */
                    ...
                    function onelinkUrlGenerator() {
                        ...
                        // onelink URL for NRE NRO Savings Account Opening
                        buildOneLinkUrl({
                            oneLinkURL: 'https://fi.onelink.me/GvZH/o6q2nn1r',
                            urlKeyName: 'oneLinkCommonUrlNR',
                            className: 'onelink-common-urlNR',
                            currentPageUrl,
                        });
                    }
                    onelinkUrlGenerator();
