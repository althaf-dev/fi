import { ClientPlatform } from "@/containers/DebitCardInternationalDeals/utils";
...
export const callMobileClientFunction = (platform: ClientPlatform, payload: any, callbackFunc: any, windowObjectName: string): void => {
    ...
    try {
        ...
        if (platform === ClientPlatform.ANDROID) {
            ...
            window?.[windowObjectName]?.[callbackFunc](stringifiedPayload);
            // eslint-disable-next-line no-console
