...
type typography = {
    ...
    h3VariantEleven: tag;
    h3VariantTwelve: tag;
    h3VariantThirteen: tag;
    h3VariantFourteen: tag;
    h3VariantFifteen: tag;
    h3VariantSixteen: tag;
    h3VariantSeventeen: tag;
    h4: tag;
    h4VariantOne: tag;
    h4VariantTwo: tag;
    h4VariantThree: tag;
    ...
    labelVariantThirteenGilray: tag;
    ...
    subText: tag;
    h1VariantFourteen: tag;
    labelVariantNineteen: tag;
};
