...
const MyFont = styled.div<{
    ...
    ${(props) => props.textWrap && "white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"}
    ...
    @media ${Device.tab} {
      font-size: ${(props) => props.fontSizeTab || props.fontSize || "20px"};
    }
  
    @media ${Device.desktop} {
      font-size: ${(props) =>
        props.fontSizeDesktop || props.fontSizeTab || props.fontSize || "20px"};
    }
  `;
...
const Column = styled.div<{ gap?: string, border?:string, borderBottom?:string,paddingBottom?:string, marginBottom?:string, height?:string, width?:string }>`
  display: flex;
...
export {
    ...
    ScrollableContainer,MarginAuto, MyFont, Title, Column
};
