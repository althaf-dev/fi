...
export const LANDED_ON_SALARY_B2B_PAGE = 'LandedOnSalaryB2BPage';
export const SCROLLED_ON_SALARY_B2B_PAGE = 'ScrollOnSalaryB2BPage';
export const LANDED_ON_SALARY_OTP_SCREEN = 'LandedOnSalaryOTPScreen';
export const ENTERED_FULL_NAME_ON_SALARY_B2B_PAGE = 'EnteredFullNameOnSalaryB2BPage';
export const ENTERED_COMPANY_NAME_ON_SALARY_B2B_PAGE = 'EnteredCompanyNameOnSalaryB2BPage';
export const ENTERED_EMAIL_ON_SALARY_B2B_PAGE = 'EnteredEmailOnSalaryB2BPage';
export const ENTERED_PHONE_ON_SALARY_B2B_PAGE = 'EnteredPhoneOnSalaryB2BPage';
export const CLICKED_BOOK_DEMO_BUTTON = 'ClickedBookDemoButton';
export const OTP_SUCCESS = 'OTPSuccess';
export const OTP_FAILURE = 'OTPFailure';
export const ENTERED_OTP_SALARY_B2B_PAGE = 'EnteredOTPOnSalaryB2BPage';
