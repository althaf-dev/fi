...
const getDeviceOSFallback = () => {
    ...
    if (window.navigator.appVersion.indexOf('Android') !== -1) { deviceOS = 'android'; }
    if (window.navigator.appVersion.indexOf('iPhone') !== -1) { deviceOS = 'ios'; }
    if (window.navigator.appVersion.indexOf('Windows') !== -1) { deviceOS = 'Windows'; }
    if (window.navigator.appVersion.indexOf('Win') !== -1) { deviceOS = 'Windows OS'; }
    if (window.navigator.appVersion.indexOf('Mac') !== -1) { deviceOS = 'MacOS'; }
    if (window.navigator.appVersion.indexOf('X11') !== -1) { deviceOS = 'UNIX OS'; }
    if (window.navigator.appVersion.indexOf('Linux') !== -1) { deviceOS = 'Linux OS'; }
