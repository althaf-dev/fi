...
import { Wrapper, LabelWithImage, LogoWrapper, OtpDescriptionWrapper } from '../styled';
import {
    selecOtpVerificationStatus, selectCreditCardEligibilityReducer, selectPhoneNumber, selectToken, selectUserDetails,
} from '../selectors';
import { mobileGenerateOtpCodeAction, mobileVerifyOtpCodeAction, onChangeCreditCardEligibilityValue } from '../actions';
import { ConsentType, OTP_RETRY_TIME } from '../constants';
...
const VerifyOtpPage = (props: VerifyOtpPageProps) => {
    ...
    const { mobileOtpRetrytime: otpRetryTime, isLoading } = useSelector(selectCreditCardEligibilityReducer, shallowEqual);
    ...
    const onNextStep = (payload) => {
        ...
        if (userDetails[ConsentType.CONSENT_TYPE_CREDIT_REPORT_DATA_PULL] && userDetails[ConsentType.CONSENT_TYPE_CREDIT_REPORT_DATA_PULL]) {
            consents = [
            ...
            <InputWrapperOne>
                ...
                <OtpDescriptionWrapper>
                    <CenterText
                        ...
                        color='GREY_3'
                    >
                        This is your OTP to to verify your phone number and
                        verify your credit score. Don&apos;t share this with anyone.
                    </CenterText>
                </OtpDescriptionWrapper>
