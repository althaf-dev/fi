...
import { NEO_BANK_HOME_PAGE_VARIANT } from '../../constants';
...
const HeroSectionNeoBank = () => (
    <Wrapper>
        <Container>
            <ContentContainer>
                <Content>
                    <Title font='h1VariantFive' tagType='h1' color='WHITE'>
                        The Best Neo Bank You’ll Meet
                    </Title>

                    <Description font='p3' tagType='h2' color='SILVER_2'>
                        A banking experience without the hassle? That’s Fi. Open an account in minutes without ever
                        leaving home. Fi also helps you get better with your money — one delightful feature at a time.
                    </Description>

                    <ButtonWrapper>
                        <a
                            href={window.oneLinkCommonUrl || HOME_PAGE_VARIANT_ONE_LINK_URL}
                            id='neobank_poster_link'
                            className='onelink-common-url'
                            target='_blank'
                            rel='noreferrer'
                        >
                            <PrimaryButton label={NEO_BANK_HOME_PAGE_VARIANT.ctaLabel} />
                        </a>
                        {/* <a
                            href={window.oneLinkAndroidUrl || playStoreUrl}
                            onClick={onGetTheFiApp(CLICKED_GET_THE_FI_APP)}
                            id='neobank_poster_playstore_link'
                        ...
                        <a
                            ...
                            id='neobank_poster_appstore_link'
...
export default HeroSectionNeoBank;
