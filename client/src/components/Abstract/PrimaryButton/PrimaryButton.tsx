...
const StyledButton = styled(Font)<{ bgcolor: string, isQRCodeShown?: boolean, fontVariant?: any, enableBoxShadow?: boolean, borderRadius?: string,
    disableTransForm?: boolean, disableBgColor?: string; disableFontColor: string; }>`
    width: 100%;
    padding: 14px;
    border: none;
    outline: none;
    ...
    &:disabled {
        ...
        ? (props.theme.color[props.disableBgColor] || 'rgba(0, 184, 153, 0.4)')
        : props.theme.color.WHITE)};
