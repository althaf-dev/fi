...
const StyledButton = styled.button<TextProps>`
    ...
    @media ${Device.tab} {
        ...
        letter-spacing: ${(props) =>
            TextSize(props).fontStyle.tab.letterSpacing};
    }
    ...
    @media ${Device.desktop} {
        ...
        letter-spacing: ${(props) =>
            TextSize(props).fontStyle.desktop.letterSpacing};
    }
`;
...
const StyledSpan = styled.span<TextProps>`
    ...
    @media ${Device.desktop} {
        font-size: ${(props) =>
            TextSize(props).fontStyle.desktop.fontSize} !important;
        font-weight: ${(props) =>
            TextSize(props).fontStyle.desktop.fontWeight} !important;
        line-height: ${(props) =>
            TextSize(props).fontStyle.desktop.lineHeight} !important;
    }
`;
