...
import { Link } from '../interfaces/elements';
 ...
 *
 */
const StyledLink = styled.a.attrs((props: Link) => ({
    href: props.url,
...
export {
    StyledContainer, UserSelectNone, OutlineNone, RangeLabelSection, CenterTextDiv, StyledLink, StyledContainerVOne,
    ScrollableContainer,
};
