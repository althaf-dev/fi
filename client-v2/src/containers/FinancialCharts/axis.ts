...
const createCommonXAxis = (chartData: any, chart: any, dFrag: any, timePeriod: any) => {
...
const create1DXAxis = (chartProperties: any, chartData: any, chart: any, dFrag: any) => {
    ...
    for (let i = 0; i < 4; i += 1) {
        ...
        if (i === 0) {
            ...
            coordinate = width && width - OFFSET_VALUES.WIDTH_MARGIN;
        } else {
...
const removeXAxis = (xAxisElement: any) => {
    if (xAxisElement) {
...
const createXAxis = (chartData: any, chartProperties: any, chart: any) => {
