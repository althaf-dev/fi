...
import { US_STOCKS_MOBILE_FN_NAME, US_STOCKS_MOBILE_WINDOW_OBJECT_NAME } from './constants';
 ...
 */
const removeEscapeCharacter = (originalString: string) => {
 ...
 */
const convertDataToParsedJson = (data: any) => {
...
const triggerMobileEvents = (eventData: IUSStocksMobileEvent, platform: ClientPlatform) => {
    ...
    callMobileClientFunction(platform, eventData, US_STOCKS_MOBILE_FN_NAME, US_STOCKS_MOBILE_WINDOW_OBJECT_NAME);
};

/**
 * retrieveTooltipInnerHTML Generate inner html for tooltip
 */
const retrieveTooltipInnerHTML = (firstSeriesPrice: any, secondSeriesPrice: any, dateTime: any) => {
