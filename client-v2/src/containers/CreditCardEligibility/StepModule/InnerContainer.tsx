...
const Modal = styled.div<{ isModalOpen?: boolean, style: any }>`
    height: 100%;
    width: 100%;
    ...
    @media ${Device.tab} {
        border-radius: 30px;
        background-color: ${(props) => props.style.tab.bgColor};
    }
...
const InnerContainer = (props: Props) => {
    const {
        isModalOpen, children, imageUrl, style
    } = props;

    return (
        <Wrapper>
            <Modal isModalOpen={isModalOpen} style={style}>
