...
const BannerWrapper = styled.div<{
    desktopBackgroundImageSrc: string;
    desktopFallbackImageSrc: string;
    mobileFallbackImageSrc: string;
    showOnDesktop?: boolean;
    mobileBackgroundImageSrc: string;
    sideBanner?: boolean;
}>`
    background-image: url(${(props) => props.mobileBackgroundImageSrc}),
        url(${(props) => props.mobileFallbackImageSrc});
    ...
    @media ${Device.desktop} {
        ...
        background-image: url(${(props) => props.desktopBackgroundImageSrc}),
            url(${(props) => props.desktopFallbackImageSrc});
...
const CalculatorBanner = (props: CalculatorBannerProps) => {
    const { bannerData, showOnDesktop, sideBanner } = props;

    if (!bannerData) {
        return <p>no banner data</p>;
    }
    ...
    const {
        ...
        url,
        desktop_image_src: {
            image_src: desktopImageSrc,
            fallback_image_src: desktopFallbackImageSrc,
        },
        mobile_image_src: {
            image_src: mobileImageSrc,
            fallback_image_src: mobileFallbackImageSrc,
        },
    } = bannerData;
    ...
    return (
        <>
            ...
            >
                <Title sideBanner={sideBanner} titleColor={titleColor}>
                    {title}
                </Title>
