...
import {
    getDifferenceBetweenTwoDates, getMonthNameFromDate, getMiliSecondPerDay, 
    formatCurrencyValue, formatTextColorBasedOnTheCondititon,
} from '../../utils';
 ...
 */
const getAmountWithMoneySuffix = (amount:number) => {
 ...
 */
const calculateFutureValue = (principalAmount:number, interestRate:number, compoundingFrequency:number, timePeriod:number) => {
    const futureValue = principalAmount * (1 + interestRate / compoundingFrequency) ** (compoundingFrequency * timePeriod);
    return futureValue;
};

const calculateFDReturns = (inputFields:any) => {
    // Input values
    const {
...
const getFDGraph = (inputFields:any) => {
...
const calculateFDOutput = (inputFields:any) => {
    // Input values
    const principalAmount = parseFloat(inputFields.find((item:any) => item.label === 'Principal Amount').value);
    const interestRate = parseFloat(inputFields.find((item:any) => item.label === 'Interest Rate').value) / 100;
    const timePeriod = parseFloat(inputFields.find((item:any) => item.label === 'Time Period').value) / 12;
    const compoundingFrequency = parseFloat(inputFields.find((item:any) => item.label === 'Compounding Frequency').value.value);
...
const getMutualFundGoalGraph = (inputFields:any) => {
...
const calculateMutualFundGoalOutput = (inputFields:any) => {
    // Input values
    const investmentGoalAmount = parseFloat(inputFields.find((item:any) => item.label === 'Investment goal amount').value);
    const investmentDuration = parseFloat(inputFields.find((item:any) => item.label === 'Investment duration').value);
    const expectedReturn = parseFloat(inputFields.find((item:any) => item.label === 'Expected return').value) / 100;
    const investingFrequency = parseFloat(inputFields.find((item:any) => item.label === 'Investing frequency').value.value);
    const investingFrequencyLabel = inputFields.find((item:any) => item.label === 'Investing frequency').value.label;
...
const getSipGraph = (inputFields:any) => {
...
const calculateSipOutput = (inputFields:any) => {
    // Input values
    const sipAmount = parseFloat(inputFields.find((item:any) => item.label === 'SIP amount').value);
    const annualSIPIncrement = parseFloat(inputFields.find((item:any) => item.label === 'Annual SIP increment').value) / 100;
    const expectedReturn = parseFloat(inputFields.find((item:any) => item.label === 'Expected return').value) / 100;
    const investmentDuration = parseFloat(inputFields.find((item:any) => item.label === 'Investment duration').value);
    const sipFrequency = parseFloat(inputFields.find((item:any) => item.label === 'SIP frequency').value.value);
    const sipFrequencyLabel = inputFields.find((item:any) => item.label === 'SIP frequency').value.label;
...
const getPPFGraph = (inputFields:any) => {
    const { investedAmount, profitEarned } = inputFields;
...
const calculatePPFOutput = (inputFields:any) => {
    // Input values
    /**
     ...
     */
    const monthlyInvestmentAmount = parseFloat(inputFields.find((item:any) => item.label === 'Annual investment amount').value);
    const investmentDuration = parseFloat(inputFields.find((item:any) => item.label === 'Investment duration').value);
    const rateOfInterest = parseFloat(inputFields.find((item:any) => item.label === 'Rate of interest').value) / 100;
...
const getEmiGraph = (inputFields:any) => {
...
const calculateEmiOutput = (inputFields:any) => {
    // Input values
    const loanAmount = parseFloat(inputFields.find((item:any) => item.label === 'Your loan amount').value);
    const loanTenure = parseFloat(inputFields.find((item:any) => item.label === 'Loan tenure').value);
    const interestRate = parseFloat(inputFields.find((item:any) => item.label === 'Interest on loan taken').value) / 100;
 ...
 */
const getNpsTable = (outputValues:any) => {
    const {
...
const getNpsGraph = (inputFields:any) => {
...
const calculateNpsOutput = (inputFields:any) => {
    // Input values
    const age = parseFloat(inputFields.find((item:any) => item.label === 'Age').value);
    const monthlyInvestment = parseFloat(inputFields.find((item:any) => item.label === 'Monthly investment').value);
    const expectedReturn = parseFloat(inputFields.find((item:any) => item.label === 'Expected return').value) / 100;
    const expectedAnnuityRate = parseFloat(inputFields.find((item:any) => item.label === 'Expected annuity return').value) / 100;
...
const getHraGraph = (inputFields:any) => {
...
const calculateHraOutput = (inputFields:any) => {
    // Input values
    const annualSalaryBasicComponent = parseFloat(inputFields.find((item:any) => item.name === 'annual salary component').value);
    const hraComponentOfSalary = parseFloat(inputFields.find((item:any) => item.name === 'hra salary component').value);
    const totalRentPaidByYouAnnually = parseFloat(inputFields.find((item:any) => item.name === 'rent paid annually').value);
    const livedInMetroCity = inputFields.find((item:any) => item.name === 'current city').value.value;
...
const getEmptyGratuityOutput = (currentCompanyTenure:number, minimumCurrentCompanyTenure:number) => {
    let outputSentence;
...
const calculateGratuityOutput = (inputFields:any) => {
    // Input values
    const salaryComponent = parseFloat(inputFields.find((item:any) => item.name === 'salary component').value);
    const currentCompanyTenure = parseFloat(inputFields.find((item:any) => item.name === 'current company tenure').value);
    const minimumCurrentCompanyTenure = parseFloat(inputFields.find((item:any) => item.name === 'current company tenure').min_value.value);
...
const getEpfGraph = (inputFields:any) => {
...
const calculateEpfOutput = (inputFields:any) => {
    // Input values
    const age = parseFloat(inputFields.find((item:any) => item.name === 'your age').value);
    const retirementAge = parseFloat(inputFields.find((item:any) => item.name === 'retirement age').value);
    const monthlySalary = parseFloat(inputFields.find((item:any) => item.name === 'monthly salary').value);
    const currentEpfBalance = parseFloat(inputFields.find((item:any) => item.name === 'current epf balance').value);
    const salaryGrowth = parseFloat(inputFields.find((item:any) => item.name === 'salary growth').value) / 100;
    const expectedReturn = parseFloat(inputFields.find((item:any) => item.name === 'expected return').value) / 100;
 ...
 */
const getTerminalEMI = (inputValues:any) => {
    const {
...
const getFinancingCostOfHomeLoan = (inputValues:any) => {
    const {
        homePrice, downPayment, loanInterestRate, loanTenure,
    } = inputValues;
 ...
 */
const getModCityReturnRate = (inputValues:any) => {
    const {
 ...
 * }
 */
const calculateRentVsBuyFutureValues = (inputValues:any) => {
    const {
 ...
 */
const calculateBreakingPointRent = (inputValues:any, fvOfHome:any, finalFvInvestment:any): any => {
 ...
 */
const getGraphTransformedArray = (graphArr:any) => {
    /**
     ...
     */
    const graphWholeYearValues = graphArr.filter((item:any) => {
     ...
     */
    return graphWholeYearValues.map((item:any) => ({ x: (item.month + 1) / 12, y: item.value / ONE_CRORE }));
};
 ...
 */
const getGraphExtraInfo = (inputValues:any) => {
 ...
 */
const getRentVsBuyGraph = (inputValues:any, outputGraphs:any) => {
                ...
                scales: {
                    y: {
                        ...
                        ticks: {
                            ...
                            callback(value:number) { // callback(value, index, ticks) {
                                return `${value}Cr`;
                            },
                        },
                        suggestedMin: 0,
 ...
 * @returns {object} The required object to render the table
 */
const getRentVsBuyTable = (outputValues:any) => {
    const {
...
const getEmptyRentVsBuyOutput = (inputValues:any) => {
...
const getOutputSentence = (inputValues:any, outputValues:any) => {
 ...
 */
const calculateRentVsBuyOutput = (inputFields:any) => {
    // User input values
    // Convert city return rate csv to json - https://stackoverflow.com/a/51023820
    const cityInfo = inputFields.find((item:any) => item.name === 'City to buy house').value.value;
    const startingRentAmt = parseFloat(inputFields.find((item:any) => item.name === 'House rent').value);
    const rentIncRate = parseFloat(inputFields.find((item:any) => item.name === 'Rate at which rent increases').value) / 100;
    const homePrice = parseFloat(inputFields.find((item:any) => item.name === 'Cost of house').value) * ONE_CRORE;
    const downPaymentPercentage = parseFloat(inputFields.find((item:any) => item.name === 'Down payment of house').value) / 100;
    const downPayment = homePrice * downPaymentPercentage;
    const loanInterestRate = parseFloat(inputFields.find((item:any) => item.name === 'Loan interest').value) / 100;
    const loanTenure = parseFloat(inputFields.find((item:any) => item.name === 'Loan tenure').value);
    const investmentReturnRate = parseFloat(inputFields.find((item:any) => item.name === 'Investment return rate').value.value) / 100;
    const cityOptimism = inputFields.find((item:any) => item.name === 'House growth rate').value / 10;
...
const calcuateCAGROutput = (inputFields:any) => {
    // Input values
    const initialValue = parseFloat(inputFields.find((item:any) => item.name === 'initial value').value);
    const finalValue = parseFloat(inputFields.find((item:any) => item.name === 'final value').value);
    const timePeriod = parseFloat(inputFields.find((item:any) => item.name === 'time period').value);
...
const calculateInflationRate = (inputFields:any) => {
    // Input values
    const currentCost = parseFloat(inputFields.find((item:any) => item.name === 'current cost').value);
    const viewOnInflation = parseFloat(inputFields.find((item:any) => item.name === 'view on inflation').value) / 2;
    const timePeriod = parseFloat(inputFields.find((item:any) => item.name === 'time period').value);
    let assumedInflationRate = inputFields.find((item:any) => item.name === 'assumed inflation rate').value;
 ...
 * @returns The graph values
 */
const getGraphTransformedArrayForFireCalc = (graphArr:any) => {
    // Modulus age by 1 to get only that item on which age is integer.
    const filterArray = graphArr.filter((item:any) => item.age % 1 === 0);

    /**
     * for x axis - showing age
     * for y axis - divide item.value by 1CR to get value in crores
     */
    return filterArray.map((item:any) => ({ x: item.age, y: item.value / ONE_CRORE }));
};
 ...
 * @returns The required object to render the graph
 */
const getFireGraph = (outputGraphs:any) => {
    ...
    const labelsValue = [...investmentPeriodGrpahValues, ...systematicWithdrawlGraphValues].map((item:any) => item.x);
 ...
 */
const calculateEPFInvestmentForFireCalc = (epfInvestmentValues:any, counter:any) => {
 ...
 */
const calculateSIPInvestmentForFireCalc = (sipInvestmentValues:any, counter:any) => {
 ...
 * @returns {object} The graph, table & output sentence
*/
const calculateFireOutput = (inputFields:any) => {
    // User input values
    const currentAgeAndRetireAge = inputFields.find((item:any) => item.name === 'Current age and Retire Age').value;
    const monthlySalary = parseFloat(inputFields.find((item:any) => item.name === 'Monthly salary').value);
    const salaryHike = parseFloat(inputFields.find((item:any) => item.name === 'Salary hike').value) / 100;
    const monthlyExpenses = parseFloat(inputFields.find((item:any) => item.name === 'Monthly expenses').value);
    const expenseHike = parseFloat(inputFields.find((item:any) => item.name === 'Expense hike').value);
    const pfBalance = parseFloat(inputFields.find((item:any) => item.name === 'Pf balance').value);
    const currentCorpusExpf = parseFloat(inputFields.find((item:any) => item.name === 'Current corpus expf').value);
    const monthlyContribution = parseFloat(inputFields.find((item:any) => item.name === 'Monthly contribution').value);
    const expectedReturn = parseFloat(inputFields.find((item:any) => item.name === 'Risk Profile').value.value) / 100;
    const sipGrowthRate = parseFloat(inputFields.find((item:any) => item.name === 'Sip growth rate').value) / 100;
    ...
    const filterInputFields = inputFields.filter((item:any) => item.type !== 'text_label_with_icon');
 ...
 * @returns The graph values
 */
const getGraphTransformedArrayForCreditCardCalc = (graphArr:any) => graphArr.map((item:any) => ({ x: item.month, y: item.value / ONE_LAKH }));
...
/**
  ...
  * @returns The required object to render the graph
  */
const getCreditCardGraph = (outputGraphs:any) => {
    ...
    // get label values that need to show in graph in x-axis
    const labelsValue = dailyOutstandingArrayValues.map((item:any) => item.x);
 ...
 */
const calculateCreditCardInterestRateOutput = (inputFields:any) => {
    // Input values
    const regularExpenses = parseFloat(inputFields.find((item:any) => item.name === 'Enter regular credit card expenses').value);
    const billToPay = parseFloat(inputFields.find((item:any) => item.name === 'How much of the bill will you pay').value);
    ...
    const getMonthlyInterest = (billAmountValue:number, paidAmountValue:number, sumProductOfDailyOutstandingAndDailyAprValue:number) => {
    ...
    const getPaidAmount = (billAmountValue:number) => {
    ...
    const getPaidAndMontlyInterestValues = (
        dayOfTheMonth:number, isStatementStartEncounteredValue:boolean, isBillGeneratedEncounteredValue:boolean, billAmountValue:number,
        sumProductOfDailyOutstandingAndDailyAprValue:number,
    ) => {
        if (dayOfTheMonth === 1) {
    ...
    const getSpentAmount = (dayOfTheMonth:number) => {
        if (dayOfTheMonth === 16) {
    ...
    const getDailyOutstandingValue = (spentAmount:number, paidAmount:number, monthlyInterestAmount:number) => {
    ...
    const getBillAmount = (dayOfTheMonth:number, dailyOutstandingValue:number, monthlyInterestAmount:number) => {
        if (dayOfTheMonth === 15) {
    ...
    const getNumberOfMonthForFullRepayment = (dayOfTheMonth:number, monthlyInterestAmount:number) => {
 ...
 * @returns {object} The required object to render the table
 */
const getCCValuebackTable = (outputValues:any) => {
    const {
 ...
 */
const calculateCCValuebackOutput = (inputFields:any) => {
    // Input values
    const monthlySpends = parseFloat(inputFields.find((item:any) => item.name === 'monthly spends').value);
