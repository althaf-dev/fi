 ...
 */
export const convertEpochDateToTime = (dateTime: any) => {
 ...
 */
export const convertEpochDateToDate = (dateTime: any) => {
    const date = new Date(dateTime);
 ...
 */
export const convertEpochToDatetime = (utcSeconds: any) => {
 ...
 */
export const convertEpochToDate = (utcSeconds: any) => {
    const date = new Date(utcSeconds * 1000);
    const day = date.toLocaleString('en-US', { day: 'numeric' });
 ...
 * @returns {string} human readable datetime Ex - 12 SEPT 2017
 */
export const convertEpochToDateYearFormat = (utcSeconds: any) => {
    const date = new Date(utcSeconds * 1000);
    const day = date.toLocaleString('en-US', { day: 'numeric' });
    const month = date.toLocaleString('en-US', { month: 'short' }).toUpperCase();
    const year = date.toLocaleString('en-US', { year: '2-digit' });
 ...
 */
export const convertEpochToDateFormat = (utcSeconds: any) => {
    const date = new Date(utcSeconds * 1000);
    const day = date.toLocaleString('en-US', { day: 'numeric' });
    const month = date.toLocaleString('en-US', { month: 'short' }).toUpperCase();
 ...
 */
export const convertEpochToTime = (utcSeconds: any) => {
    const date = new Date(utcSeconds * 1000);
    const time = date.toLocaleString('en-US', {
        hour: 'numeric',
        minute: 'numeric',
 ...
 */
export const convertEpochToYear = (utcSeconds: any) => {
    const date = new Date(utcSeconds * 1000);
 ...
 */
export const convertEpochDateToDatetime = (dateTime: any) => {
    const date = new Date(dateTime);
    const time = date.toLocaleString('en-US', {
        hour: 'numeric',
        minute: 'numeric',
