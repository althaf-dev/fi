 ...
 */
const convertAmountToString = (amount: any) => {
 ...
 *
 * @param dataURL - The data URL from which to extract the base64 string.
 * @returns The base64 string extracted from the data URL.
 *
 * @example
 * // Returns 'SGVsbG8gd29ybGQ='
 * getBase64StringFromDataURL('data:text/plain;base64,SGVsbG8gd29ybGQ=');
 */
