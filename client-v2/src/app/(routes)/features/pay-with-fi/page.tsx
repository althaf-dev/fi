...
export async function generateMetadata(): Promise<Metadata> {
    const metaData = getMetaTags(pageMetaMap['features/pay-with-fi']);
    return metaData;
}
    ...
    return (
        <>
            <script
                ...
                dangerouslySetInnerHTML={{ __html: htmlSanitization(JSON.stringify(applicationLdJson({ ...pageMetaMap['features/pay-with-fi'] }))) }}
            />
