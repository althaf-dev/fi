...
export async function generateMetadata(): Promise<Metadata> {
    const metaData = getMetaTags(pageMetaMap['features/accounts']);
    return metaData;
}
    ...
    return (
        <>
            <script
                ...
                dangerouslySetInnerHTML={{ __html: htmlSanitization(JSON.stringify(applicationLdJson({ ...pageMetaMap['features/accounts'] }))) }}
            />
