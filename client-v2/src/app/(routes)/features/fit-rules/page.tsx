...
export async function generateMetadata(): Promise<Metadata> {
    const metaData = getMetaTags(pageMetaMap['features/fit-rules']);
    return metaData;
}
    ...
    return (
        <>
            <script
                ...
                dangerouslySetInnerHTML={{ __html: htmlSanitization(JSON.stringify(applicationLdJson({ ...pageMetaMap['features/fit-rules'] }))) }}
            />
