...
export async function generateMetadata(): Promise<Metadata> {
    const metaData = getMetaTags(pageMetaMap['us-stocks']);
    return metaData;
}
    ...
    return (
        <>
            <script
                ...
                dangerouslySetInnerHTML={{ __html: htmlSanitization(JSON.stringify(applicationLdJson({ ...pageMetaMap['us-stocks'] }))) }}
            />
