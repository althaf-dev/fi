...
const TransitionWrapper = styled.div<{ type: number }>`
    ...
    transform: ${function (props) {
        if (props.type === 1) return 'translateX(0px)';
        if (props.type === 2) return 'translateX(-172px)';
        return 'translateX(-344px)';
    }};
    ...
    transform: ${(props) => {
        const getTranslation = () => {
            if (props.type === 1) return 'translateX(0px)';
            if (props.type === 2) return 'translateX(-300px)';
            return 'translateX(-600px)';
        };
...
const AppImageGridSection = (props: AppImageGridSectionProps) => {
    ...
    useEffect(() => {
        if (width! > WINDOW_SIZE.DESKTOP && type !== 1) {
            setType(1);
        }
    }, [width]);
    useEffect(() => {
            ...
            <GridHolderContainer>
                <GridContainer>
                    ...
                    <GridChild5>
                        <Image
                            icon={
                                isType1Grid ? GridType1Image2 : GridType2Image2
                            }
                            alt='cart 5'
                            loadingType='lazy'
                            fallBackImage={
