...
const Input = (props: InputProps) => {
    const {
        ...
        caretColor, labelFont, label, clicked, isValid = () => {}, onChange, setButtonClick, onKeyDown, className, onBlur = () => {}, validation = {}
    } = props;
    ...
    const onInputChange = (event: any) => {
        ...
        clicked && setButtonClick && setButtonClick();
            ...
            <StyledInput
                ...
                onKeyDown={(event) => {
                    ...
                    if (event.keyCode === 13 && (event.target as HTMLInputElement).value) {
                        ...
                        if (props.onEnterClick) props.onEnterClick(event);
                    }
                }}
                id={testId}
