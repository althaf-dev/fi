...
import { getEncodedPlayStoreURL } from '../../utils';
...
const QRCodeSection = (props: QRCodeSectionProps) => {
    ...
    const onGetTheFiApp = (key: any) => () => {
        trackEvent(key, { ...trackingData, method: 'manual', entry_point: 'home_page' });

        trackGTMEvent(key);
    };

    let oneLinkAndroidUrl = '';
    let oneLinkIosUrl = '';

    useEffect(() => {
        // eslint-disable-next-line react-hooks/exhaustive-deps
        oneLinkAndroidUrl = (globalThis.window as any)?.oneLinkAndroidUrl;
        // eslint-disable-next-line react-hooks/exhaustive-deps
        oneLinkIosUrl = (globalThis.window as any)?.oneLinkIosUrl;
    }, []);
        ...
        <Container isQRCodeShown={isQRCodeShown} onMouseOver={showQRCode} onMouseLeave={hideQRCode} alignQRCodeInCenter={alignQRCodeInCenter}>
            <Wrapper isQRCodeShown={isQRCodeShown}>
                <div>
                    ...
                    <ButtonWrapper>
                        <a
                            href={oneLinkAndroidUrl || playStoreUrl}
                        ...
                        <a
                            href={oneLinkIosUrl || IOS_APP_STORE_URL}
